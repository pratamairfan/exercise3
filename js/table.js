...
function process() {
    ...
    let rotation_period = parseInt(document.getElementById('rotation_period').value);
    let orbital_period = parseInt(document.getElementById('orbital_period').value);
    ...
    for (var i = 0; i < obj.length; i++) {
        head = head + "<tr><td>" + obj[i].name + "</td><td>" + obj[i].rotation_period + "</td><td>" + obj[i].orbital_period + "</td><td>" + obj[i].diameter + "</td><td>" + obj[i].climate + "</td</tr>";
...
function reset() {
    ...
    document.getElementById('rotation_period').value = "";
